(function (global, factory) {
  ...
  */
   ...
   */
		function prettyPojo(obj) {
			if (typeof obj == "string") writer.write("\"" + obj + "\"");else if (typeof obj == "number") writer.write(obj);else if (typeof obj == "boolean") writer.write(!!obj ? "true" : "false");else if (isArray(obj)) {
				writer.write("[ ");
  ...
  */
	function isLiteral(obj) {
		if (obj === null || typeof obj === "string" || typeof obj === "number" || typeof obj === "boolean") return true;
		return false;
	}
